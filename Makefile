...
pkgdatadir = $(datadir)/jnitacoin
pkgincludedir = $(includedir)/jnitacoin
pkglibdir = $(libdir)/jnitacoin
pkglibexecdir = $(libexecdir)/jnitacoin
...
ACLOCAL = ${SHELL} /tmp/JNitaCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/JNitaCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/JNitaCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/JNitaCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = jnitacoin-cli
BITCOIN_DAEMON_NAME = jnitacoind
BITCOIN_GUI_NAME = jnitacoin-qt
BITCOIN_TX_NAME = jnitacoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The JNitaCoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = JNitaCoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/JNitaCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = jnitacoin
PACKAGE_BUGREPORT = https://github.com/jnitacoin-project/jnitacoin/issues
PACKAGE_NAME = JNitaCoin Core
PACKAGE_STRING = JNitaCoin Core 0.16.3
PACKAGE_TARNAME = jnitacoin
PACKAGE_URL = https://jnitacoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/JNitaCoin
abs_srcdir = /tmp/JNitaCoin
abs_top_builddir = /tmp/JNitaCoin
abs_top_srcdir = /tmp/JNitaCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/JNitaCoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/JNitaCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/JNitaCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/JNitaCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/JNitaCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
